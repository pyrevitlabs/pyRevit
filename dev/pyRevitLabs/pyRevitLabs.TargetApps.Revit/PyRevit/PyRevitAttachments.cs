    ...
    public static class PyRevitAttachments {
        ...
        public static List<PyRevitAttachment> GetAttachments() {
            ...
            foreach (var revit in RevitProduct.ListInstalledProducts()) {
                ...
                var userManifest = RevitAddons.GetAttachedManifest(revit.ProductYear, allUsers: false);
                var allUsersManifest = RevitAddons.GetAttachedManifest(revit.ProductYear, allUsers: true);
