...
namespace pyRevitLabs.PyRevit
{
    public static class PyRevitAttachments
    {
            ...
            bool force = false)
        {
            ...
            if (engine.Runtime)
            {
                logger.Debug(string.Format("Attaching Clone \"{0}\" @ \"{1}\" to Revit {2}", clone.Name,
                    clone.ClonePath, revitYear));
        ...
        public static IEnumerable<PyRevitAttachment> GetAttachments()
        {
            ...
            foreach (var revit in RevitProduct.ListInstalledProducts())
            {
                ...
                var allUsersManifest =
                    RevitAddons.GetAttachedManifest(PyRevitConsts.AddinName, revit.ProductYear, allUsers: true);
                ...
                {
                    var userManifest =
                        RevitAddons.GetAttachedManifest(PyRevitConsts.AddinName, revit.ProductYear, allUsers: false);
