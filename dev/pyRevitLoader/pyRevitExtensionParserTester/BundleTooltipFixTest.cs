...
{
    [TestFixture]
    public class BundleTooltipFixTest
    {
        [Test]
        public void TestTooltipParsingFix()
        {
            ...
            var testExtensionDir = Path.Combine(tempDir, "TestExt.extension");
...
";
            ...
            {
                // Clean up
                if (Directory.Exists(testExtensionDir))
                {
                    Directory.Delete(testExtensionDir, true);
                }
            }
        }
