...
namespace pyRevitLabs.PythonNet {
    ...
    public class Runtime {
        ...
        // binary substitution of different pyRevitLabs.PythonNet.dll builds in a target application.

        public static int UCS => _UCS;

#if UCS4
        public const int _UCS = 4;
...
#if PYTHON27
        public const string _pyversion = "2.7";
        public const string _pyver = "27";
#elif PYTHON34
...
#error You must define one of PYTHON34 to PYTHON37 or PYTHON27
        ...
        public const string dllBase = "python" + _pyversion;
#else // Windows
        public const string dllBase = "python" + _pyver;
#endif

#if PYTHON_WITH_PYDEBUG
        public const string dllWithPyDebug = "d";
#else
        public const string dllWithPyDebug = "";
#endif
#if PYTHON_WITH_PYMALLOC
        public const string dllWithPyMalloc = "m";
#else
        public const string dllWithPyMalloc = "";
#endif
        ...
        /// <summary>
        /// Function to access the public PyUnicode/PyString object and
