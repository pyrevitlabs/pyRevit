...
SESSION_REPLACED_ENVVAR = PRODUCT_NAME + "_SESSIONREPLACED"
CONFIGUPGRADED_ENVVAR = PRODUCT_NAME + "_CONFIGUPGRADED"
CHECKUPDATES_TIMESTAMP_ENVVAR = PRODUCT_NAME + "_CHECKUPDATESTIMESTAMP"
CHECKUPDATES_RESULT_ENVVAR = PRODUCT_NAME + "_CHECKUPDATESRESULT"
...
SESSIONSTARTTIME_ENVVAR = PRODUCT_NAME + "_SESSIONSTARTTIME"
OUTPUTSETUPTIME_ENVVAR = PRODUCT_NAME + "_OUTPUTSETUPTIME"
