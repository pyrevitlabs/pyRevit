...
namespace PyRevitBaseClasses
{
    ...
    public static class ExternalConfig
    {
        ...
        public static string defaultelement = "<div style=\"margin-top:3px;" +
                                                           "margin-bottom:3px;" +
                                                           "padding-right:6px;" +
                                                           "padding-left:6px;" +
                                                           "\"></div>";

        public static string errordiv = "<div style=\"margin-top:10px;" +
                                        "padding:6px;" +
        ...
        public static string progressbar = "<div style=\"position:fixed;" +
                                           "bottom:0px;" +
                                           "width:100%;" +
                                           "height:8px;" +
                                           "font-size:1pt;" +
