"""Prepare and compile Grasshopper script types."""
...
def _make_gh_types(extension, module_builder, cmd_component): #pylint: disable=W0613
...
def create_gh_types(extension, cmd_component, module_builder=None):
    if module_builder:
        _make_gh_types(extension, module_builder, cmd_component)
    else:
        cmd_component.class_name = cmd_component.unique_name
