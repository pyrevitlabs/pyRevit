...
from pyrevit import HOST_APP, MAIN_LIB_DIR, PYTHON_LIB_DIR, MISC_LIB_DIR, PyRevitException
...
class GenericUIComponent(GenericComponent):
    def __init__(self):
        ...
        self.syspath_search_paths = [MAIN_LIB_DIR, PYTHON_LIB_DIR, MISC_LIB_DIR]
        self.icon_file = None
