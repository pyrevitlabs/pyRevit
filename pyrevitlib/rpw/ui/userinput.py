...
from forms.forms import WPFWindow
...
class SelectFromCheckBoxes(TemplateUserInputWindow):
            ...
            <DockPanel Margin="10">
                ...
                <StackPanel DockPanel.Dock="Bottom">
                    <Grid>
                        ...
                        <Button x:Name="checkall_b" Grid.Column="0"
                                Grid.Row="0" Content="Check"
                                Click="check_all" Margin="0,10,3,0"/>
                        <Button x:Name="uncheckall_b" Grid.Column="1"
                                Grid.Row="0" Content="Uncheck"
                                Click="uncheck_all" Margin="3,10,3,0"/>
                        <Button x:Name="toggleall_b" Grid.Column="2"
                                Grid.Row="0" Content="Toggle"
                                Click="toggle_all" Margin="3,10,0,0"/>
                    </Grid>
    ...
    def _setup(self, **kwargs):
        ...
        #     color_brush = SolidColorBrush(Color.FromRgb(
        #                                   color_tuple[0],
        #                                   color_tuple[1],
        #                                   color_tuple[2]));
...
# todo: fix and rewrite with new WPF window system
...
class TextInputForm(TemplateUserInputWindow):
    pass
