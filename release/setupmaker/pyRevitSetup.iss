...
[Run]
Filename: "{tmp}\pyrevitgitservices.exe"; Parameters:"clone release/v4.5-beta {app}\pyRevit"; StatusMsg: "Cloning pyRevit repository from Github...This might take a while..."; Flags: runhidden
