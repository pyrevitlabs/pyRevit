...
BASE_CLASSES_ASM_FILE = appdata.get_data_file(BASE_CLASSES_ASM_FILE_ID, ASSEMBLY_FILE_TYPE)
...
def _get_base_classes_asm():
    if appdata.is_data_file_available(file_id=BASE_CLASSES_ASM_FILE_ID, file_ext=ASSEMBLY_FILE_TYPE):
        return load_asm_file(BASE_CLASSES_ASM_FILE)
    else:
