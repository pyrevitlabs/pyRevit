...
from pyrevit.loader.parser import get_installed_lib_package_data, get_installed_package_data, get_parsed_package
...
if user_config.cache_type == CACHE_TYPE_ASCII:
    from pyrevit.loader.cacher_asc import is_cache_valid, get_cached_package, update_cache
else:
    from pyrevit.loader.cacher_bin import is_cache_valid, get_cached_package, update_cache
...
def load():
    """Handles loading/reloading of the pyRevit addin and packages packages.
