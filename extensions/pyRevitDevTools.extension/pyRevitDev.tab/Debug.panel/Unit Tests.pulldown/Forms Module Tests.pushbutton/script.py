...
print(
    forms.ask_for_string(
        default="test default", prompt="test prompt", title="test title"
    )
)
...
print(
    forms.ask_for_date(default="2018/11/09", prompt="test prompt", title="test title")
)
...
test_forms(
    forms.select_views, test_title="Testing Selecting Views", filterfuncstr="pyRevit"
)

test_forms(
    forms.select_sheets, test_title="Testing Selecting Sheets", filterfuncstr="pyRevit"
)
