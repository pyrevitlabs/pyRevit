...
for tstring in TEST_STRINGS:
    ...
    if m:
        print("\tMatched: {}".format(pyrevit.PYREVIT_FILE_PREFIX_STAMPED_USER_REGEX))
    ...
    if m:
        print("\tMatched: {}".format(pyrevit.PYREVIT_FILE_PREFIX_UNIVERSAL_USER_REGEX))
        print("\t" + str(m.groupdict()))

    # e.g. pyRevit_
    m = re.match(pyrevit.PYREVIT_FILE_PREFIX_UNIVERSAL_REGEX, tstring)
    if m:
        print("\tMatched: {}".format(pyrevit.PYREVIT_FILE_PREFIX_UNIVERSAL_REGEX))
        print("\t" + str(m.groupdict()))
