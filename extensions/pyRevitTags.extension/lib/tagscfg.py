...
def get_modifier_defs():
    return [
        TagModifierDef(abbrev="IFF", name="Issued for Fabrication", color="#f39c12"),
        TagModifierDef(abbrev="IFC", name="Issue For Construction", color="#c7254e"),
        TagModifierDef(abbrev="IFR", name="Issue For Review", color="#a4cc00"),
        TagModifierDef(
            abbrev="ASBUILT", name="As-Built Content", color=TAGS_MODIFS_COLOR_DEFAULT
        ),
        TagModifierDef(abbrev="NIC", name="Not in Contract", color="#1273fc"),
        TagModifierDef(abbrev="VIF", name="Verified In Field", color="#4f8b16"),
    ]
