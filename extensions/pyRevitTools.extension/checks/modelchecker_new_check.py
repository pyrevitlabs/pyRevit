        ...
        if not doc.IsFamilyDocument:
            ...
            if all_warnings_count > 0:
                try:
                    ...
                    print(e)
            # Links
            _, rvtlinks_elements_items, rvtlinks_count, type_status, rvtlinks_docs = rvtlinks_elements(
                doc)
            if rvtlinks_count != 0:
            ...
            if rvtlinks_count != 0:
                ...
                for rvtlink in rvtlinks_docs:
                    ...
                    if rvtlink is not None:
                        ...
                        critical_warnings_count = critical_warnings(warnings_guid,CRITICAL_WARNINGS)
                        # Links
                        _, rvtlinks_elements_items, rvtlinks_count, type_status, rvtlinks_docs = rvtlinks_elements(rvtlink)
