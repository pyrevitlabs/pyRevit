...
translations = TRANSLATIONS_CONFIG.get(
    user_config.user_locale, TRANSLATIONS_CONFIG["en_us"]
...
if results:
    ...
    my_config.set_option(
        "set_all", selected_items.get(translations["Options.SetAll.Text"], False)
    )
    my_config.set_option(
    ...
    if selected_items.get(translations["Options.CustomPrefixRvt.Text"], False):
        ...
        custom_prefix_value = forms.ask_for_string(
            default=custom_prefix_value, prompt=translations["PrefixRvt.Prompt"]
        )
    ...
    if selected_items.get(translations["Options.CustomPrefixDwg.Text"], False):
        ...
        custom_prefix_value = forms.ask_for_string(
            default=custom_prefix_value, prompt=translations["PrefixDwg.Prompt"]
        )
