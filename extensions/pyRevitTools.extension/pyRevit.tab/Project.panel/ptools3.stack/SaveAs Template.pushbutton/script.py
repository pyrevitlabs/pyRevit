"""Save As Template
This tool uses the postable command to save your template with the SaveAs command
...
CmndID = RevitCommandId.LookupCommandId('ID_REVIT_SAVE_AS_TEMPLATE')
CmId = CmndID.Id
