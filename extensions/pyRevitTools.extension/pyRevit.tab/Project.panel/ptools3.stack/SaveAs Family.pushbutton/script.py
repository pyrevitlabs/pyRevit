"""Save As Family
This tool uses the postable command to save your families with the SaveAs command
...
CmndID = RevitCommandId.LookupCommandId('ID_SAVE_FAMILY_ANY')
CmId = CmndID.Id
