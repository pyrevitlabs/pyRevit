...
__doc__ = 'This is a tool to swap line styles. Run the tool, select a line with the style to be replaced, and then ' \
          'select a line with the scriptexec style. The script will correct the line styles in the model. ' \
...
try:
    ...
    toStyleLine = doc.GetElement(uidoc.Selection.PickObject(ObjectType.Element, 'Pick a line with the scriptexec style.'))
